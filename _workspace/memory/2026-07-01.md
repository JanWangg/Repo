...
date: 2026-07-01
memory_type: working
topic: "2026-07-01 知識統一完成 + Push 防護觸發"
linked_knowledge:
  - /workspace/jan-vault/INDEX.md
  - /workspace/jan-vault/_workspace/SECURITY_SOP.md
  - /workspace/jan-vault/_workspace/SECURITY.md
  - /workspace/jan-vault/_workspace/TODO.md
...
### 2. 知識統一（上午）
- Jan 決策：「知識統一」
- 全量備份 6 個來源 → /workspace/backup/before_unify_20260701_120752/
- 合併兩個 .git（單一 repo）
- 整合 4 個來源進 vault（Jan-知識庫 + memory + daily_notes + 元檔）
...
- 排除 _raw_getnotes/（移到 /workspace/backup/_raw_getnotes_20260701/）
